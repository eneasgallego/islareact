...
export default (state = getInitialState(), action = {}) => {
    ...
    case CARGAR_FILAS_TABLA_START:
        return cargarFilasTablaStart(state, action, ID_INICIO_NECESITA);
    case CARGAR_FILAS_TABLA_SUCCESS:
        return cargarFilasTablaSuccess(state, action, ID_INICIO_NECESITA);
    case CARGAR_FILAS_TABLA_ERROR:
        return cargarFilasTablaError(state, action, ID_INICIO_NECESITA);
    default:
        return state;
    }
};
